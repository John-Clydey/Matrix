...
[data-testid="stAppViewContainer"] > .main {
    background-image: url("https://images6.alphacoders.com/121/thumb-350-1211942.webp");
...
st.markdown("<style> .allura-text { font-family: 'Allura', cursive; font-size: 40px; color: cyan; } </style>",
            unsafe_allow_html=True)

st.markdown("<h1 style='text-align: center; font-size: 80px; font-weight: bold; color: yellow;'>COSMOS MATRICIS🖥️</h1>",
            unsafe_allow_html=True)
st.markdown(
...
with col1:
    st.markdown("""
        <h1 style="font-size: 24px; font-family: 'Arial, sans-serif'; text-align: center; color: yellow">
...
with col4:
    st.markdown("""
        <h1 style="font-size: 24px; font-family: 'Arial, sans-serif'; text-align: center; color: violet">
...
with col8:
    st.markdown("""
            <h1 style="font-size: 24px; font-family: 'Arial, sans-serif'; color: violet">
            Matrix B:
            </h1>
        """, unsafe_allow_html=True)
    matB = []
